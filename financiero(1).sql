...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 14-01-2021 a las 04:30:11
...
--
DELIMITER $$
CREATE TRIGGER `Trigger_IncStock` AFTER INSERT ON `detcompra` FOR EACH ROW update productos set stock = stock + new.cantidad 
...
INSERT INTO `productos` (`id_producto`, `nombre`, `descripcion`, `modelo`, `stock`, `id_marca`, `id_categoria`, `id_proveedor`) VALUES
(6, 'Smartphone', '4G LTE 3gb ram', 'S20', 5, 2, 1, 4),
(8, 'Samsung Galaxy S6', '3 gb ram\n32 gb almacenamiento\n4g lte', 'SM-G925P', 4, 2, 2, 4);
...
--
ALTER TABLE `detcompra`
  MODIFY `id_detCompra` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT de la tabla `detventa`
--
ALTER TABLE `detventa`
  MODIFY `id_detVenta` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
